...
import com.scorpion.allinoneeditor.audioeditor.Activity.MergeAudios;
import com.scorpion.allinoneeditor.audioeditor.Activity.MixAudios;
...
public class MergeAdapter extends ArrayAdapter<MediaItem> {
    MergeAudios context;
    ...
    public MergeAdapter(MergeAudios selectAudioActivity, int i, ArrayList<MediaItem> arrayList) {
