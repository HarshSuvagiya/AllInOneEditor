...
import com.scorpion.allinoneeditor.videoeditor.activity.SelectAudioActivity;
...
public class SongAdapter extends ArrayAdapter<MediaItem> {
    ...
    public SongAdapter(SelectAudioActivity selectAudioActivity, int i, ArrayList<MediaItem> arrayList) {
