...
public class VideoToGif extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
        ...
        public void run() {
            if (videoview != null && videoview.isPlaying()) {
                ...
                try {
                    ...
                    textView.setText("" + VideoToGif.formatTimeUnit((long) currentPosition));
    ...
    public void onCreate(Bundle bundle) {
        ...
        videotogif.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
//                FBInterstitial.getInstance().displayFBInterstitial(VideoToGif.this, new FBInterstitial.FbCallback() {
//                    public void callbackCall() {

                ShowInter(VideoToGif.this);
//                    }
//                });
            }
        });
    ...
    private void initVideoView() {
        videoview.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            public void onPrepared(MediaPlayer mediaPlayer) {
                ...
                try {
                    ...
                    textView.setText("" + VideoToGif.formatTimeUnit((long) duration));
        ...
        videoview.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
                VideoToGif videoToGif = VideoToGif.this;
                videoToGif.isVgood = false;
                Toast.makeText(videoToGif, "Video Player Supporting issue.", Toast.LENGTH_SHORT).show();
                try {
                    handler.removeCallbacks(seekrunnable);
                    return true;
                } catch (Exception unused) {
    ...
    private class SaveTask extends AsyncTask<Void, Void, Void> {
        ...
        public Void doInBackground(Void... voidArr) {
            VideoToGif videoToGif = VideoToGif.this;
            videoToGif.make(videoToGif.vid_path);
            return null;
        }
    }
    ...
    public void make(String str2) {
        ...
        File file = new File(externalStorageDirectory, getString(R.string.app_name) + "/" + getString(R.string.gif));
        if (!file.exists()) {
            file.mkdir();
        }
        dstPath = file.getAbsolutePath() + "/Gif_" + format + ".gif";
        String[] strArr = {"-y", "-i", str2, "-vf", "scale=500:-1", "-t", "10", "-r", "10", dstPath};
...
//                        public void run() {
//                            creationDialog.dismissDialog();
//                            Intent intent = new Intent(VideoToGif.this, GifPlayer.class);
//                            intent.putExtra("videourl", dstPath);
//                            startActivity(intent);
//                            finish();
//
